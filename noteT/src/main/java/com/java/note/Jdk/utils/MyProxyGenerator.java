...
public class MyProxyGenerator {
    ...
    private static String getFieldType(Class<?> var0) {
        if (var0.isPrimitive()) {
            return MyProxyGenerator.PrimitiveTypeInfo.get(var0).String;
        } else {
    ...
    private static class PrimitiveTypeInfo {
        ...
        private PrimitiveTypeInfo(Class<?> var1, Class<?> var2) {
            ...
            this.String = Array.newInstance(var1, 0).getClass().getName().substring(1);
            this.wrapperClassName = MyProxyGenerator.dotToSlash(var2.getName());
            this.wrapperValueOfDesc = "(" + this.String + ")L" + this.wrapperClassName + ";";
            this.unwrapMethodName = var1.getName() + "Value";
            this.unwrapMethodDesc = "()" + this.String;
        }
