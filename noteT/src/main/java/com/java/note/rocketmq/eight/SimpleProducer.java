 ...
 * @Description 下面的示例演示如何在同步、异步或单向传输中向RocketMQ代理发送消息。
 */
public class SimpleProducer {
    ...
    public static void main(String[] args) {
        ...
        {
            Message message = (Message) producer.createBytesMessage("OMS_HELLO_TOPIC", "OMS_HELLO_BODY".getBytes(Charset.forName("UTF-8")));
