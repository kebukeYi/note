...
public class MySQLLoad {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        System.out.println("DriverManager.getClassLoader() : " + DriverManager.class.getClassLoader());
        ...
        while (drivers.hasMoreElements()) {
            ...
            System.out.println("driver.getClassLoader() : " + driver.getClass().getClassLoader());
        }
