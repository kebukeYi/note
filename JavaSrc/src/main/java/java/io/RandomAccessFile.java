...
public class RandomAccessFile implements DataOutput, DataInput, Closeable {
    ...
    //RandomAccessFile 类提供的是同样的抽象内容。
    // 在通道出现之前，底层的文件操作都是通过 RandomAccessFile 类的方法来实现的。
    // FileChannel 模拟同样的 I/O 服务，因此它的 API 自然也是很相似的

    //
    private FileDescriptor fd;

    //FileChannel 1.4 版本开始使用，和这个 RandomAccessFile 有什么关系？
    //
